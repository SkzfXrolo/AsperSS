...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'scan_modules.yara_java', 'scan_modules.high_value_checks',
        'scan_modules.jar_structure',
        'scanners', 'scanners._safe_runner', 'ss_forensics', 'ss_verdict', 'ss_integrity',
        'scan_pipeline', 'fp_filter', 'ss_pin', 'issue_enrichment', 'forensic_match',
        'results_display', 'utils.yara_scan',
        'mouse_weight_detector', 'bundle_runtime',
        'config', 'config.scanner_custom', 'config.hack_signatures', 'config.version',
        'config.lite_mode', 'config.scan_paths', 'config.whitelist', 'config.profiles',
